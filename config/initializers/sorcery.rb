...
# The default is nothing which will include only core features (password encryption, login/logout)</pe
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `3600`
  #
  config.session_timeout = 60 * 60 * 24 * 30 * 6
  ...
  config.user_config do |user|
    ...
    # Default: `604800`
    #
    user.remember_me_for = 60 * 60 * 24 * 30 * 6
